...
public class entityListener extends EntityListener {
    ...
    public static void dropMoney(Player deaded) {
        ...
        double dropped;
        if (tollAsPercent)
            dropped = Register.getPercentMoney(deaded, tollAmount/100);
        else
            dropped = tollAmount;
    ...
    public static void rewardPvP(Player deaded, Record deadedRecord) {
        ...
        switch (rewardType) {
            case PERCENT_KDR:
                reward = Register.getPercentMoney(deaded, (deadedKDR / killerKDR) / 100.0);
                break;
            ...
            case PERCENT_RANGE:
                ...
                reward = Register.getPercentMoney(deaded, rangePercent);
                break;
            ...
            case KARMA:
                ...
                reward = Register.getPercentMoney(deaded, karmaPercent);
    ...
    public static String getMsg(String msg, double amount, String killed, String killer, String karma) {
        ...
        return msg.replaceAll("<amount>", Register.format(amount));
    }
